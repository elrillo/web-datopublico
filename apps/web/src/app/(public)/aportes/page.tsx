    ...
    return (
        <div className="container mx-auto px-4 py-12 max-w-5xl space-y-16">
            ...
            <section className="grid md:grid-cols-3 gap-8">
                <Card className="relative overflow-hidden border-border/50 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                    <CardHeader>
                    ...
                    <CardContent className="space-y-4">
                        <div className="text-3xl font-bold tracking-tight">$3.000 <span className="text-sm font-normal text-muted-foreground">/ único</span></div>
                        <p className="text-sm text-muted-foreground">
                            Invítanos un café para seguir programando hasta tarde.
                        </p>
                        <Button className="w-full" variant="outline">Aportar $3.000</Button>
                    </CardContent>
                </Card>

                <Card className="relative overflow-hidden border-primary shadow-lg hover:shadow-2xl transition-all duration-300 scale-105 z-10 hover:-translate-y-1">
                    ...
                    <CardContent className="space-y-4">
                        <div className="text-3xl font-bold tracking-tight">$5.000 <span className="text-sm font-normal text-muted-foreground">/ mes</span></div>
                        <p className="text-sm text-muted-foreground">
                            Ayúdanos a mantener los servidores activos 24/7.
                        </p>
                        <Button className="w-full shadow-md hover:shadow-lg transition-shadow">Suscribirse</Button>
                    </CardContent>
                </Card>
                ...
                <Card className="relative overflow-hidden border-border/50 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                    ...
                    <CardContent className="space-y-4">
                        <div className="text-3xl font-bold tracking-tight">$20.000 <span className="text-sm font-normal text-muted-foreground">/ mes</span></div>
                        <p className="text-sm text-muted-foreground">
            ...
            <section className="bg-muted/30 rounded-2xl p-8 md:p-12">
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    <div className="space-y-6">
                        <h2 className="text-3xl font-bold">¿Por qué aportar?</h2>
