...
export default async function SaludPage() {
    ...
    return (
        <div className="container mx-auto py-8 px-4">
            <div className="mb-8">
                <h1 className="text-3xl font-bold tracking-tight">Datos de Salud</h1>
                <p className="text-muted-foreground mt-2">
                    Visualización de compras públicas en el sector Salud.
                </p>
            </div>

            <ComprasDashboard initialData={compras} defaultSector="Salud" />
        </div>
    );
}
